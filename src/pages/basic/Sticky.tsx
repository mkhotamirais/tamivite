...
function Sticky1() {
  return (
    <header>
      <nav className="sticky top-0 bg-gray-400 text-white text-center p-5">Header Sticky1</nav>
...
function Sticky2() {
  return (
    <header>
      <div>
        <nav className="sticky top-0 bg-gray-400 text-white text-center p-5 border border-y">Header Sticky2 A</nav>
        <section className="w-full h-[50vh] bg-gray-200 flex items-center justify-center">Section Sticky A</section>
      </div>
      <div>
        <nav className="sticky top-0 bg-gray-400 text-white text-center p-5 border border-y">Header Sticky2 B</nav>
        <section className="w-full h-[50vh] bg-gray-200 flex items-center justify-center">Section Sticky B</section>
      </div>
      <div>
        <nav className="sticky top-0 bg-gray-400 text-white text-center p-5 border border-y">Header Sticky2 C</nav>
...
function Sticky3() {
  return (
    <main className="flex">
      <aside className="sticky self-start top-0 bg-gray-200 w-[30vw] h-[80vh] text-center my-[10vh] flex items-center justify-center">
...
function Sticky4() {
  return (
    <main className="grid grid-cols-5">
      <aside className="sticky top-0 col-span-1 bg-gray-200 h-[80vh] my-[10vh] text-center grid place-items-center">
        aside grid
      </aside>
